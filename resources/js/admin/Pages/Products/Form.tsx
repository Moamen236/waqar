                        ...
                        <div className="card">
                            <div className="card-header">
                                <Tabs defaultActiveKey="general" className="nav-tabs card-header-tabs border-0">
                                    <Tab eventKey="general" title={t('admin.generalDetail')}>
                                        <div className="row">
                                            ...
                                            <div className="col-lg-6">
                                                <div className="mb-3">
                                                    <label className="form-label">
                                                        {t('admin.slugAutoGeneratedIfBlank')}
                                                    </label>
                                    ...
                                    <Tab eventKey="images" title={t('admin.productImages')}>
                                        <h5 className="fs-14 mb-1">{t('admin.productGallery')}</h5>
                                        <p className="text-muted fs-13">{t('admin.addProductGalleryImages')}</p>
                                    ...
                                    <Tab eventKey="pricing" title={t('admin.pricingVariants')}>
                                    ...
                                    <Tab eventKey="organization" title={t('admin.organization')}>
                                        <div className="row">
                                            <div className="col-lg-4">
                                                <div className="mb-3">
